...
<head>
    ...
    <title>Aziz Portfolio</title>
</head>
<body>
    <nav>
        <div class="nav-container">
            <div class="logo" data-aos="zoom-in" data-aos-duration="1500">
                Ahmad Aziz <span>Satrya Rahmada</span>
            </div>
            <div class="links">
    ...
    <section>
        <div class="main-container">
            ...
            <div class="content">
                <h1 data-aos="fade-left" data-aos-duration="1500" data-aos-delay="700">Hi!, saya<span>Aziz</span></h1>
                ...
                <p data-aos="flip-down" data-aos-duration="1500" data-aos-delay="1100">Ahmad Aziz Satria Rahmada lahir di Bandung pada 31 Januari 2005. Ia dikenal sebagai pribadi yang penuh semangat, kreatif, dan memiliki rasa ingin tahu yang tinggi. Ahmad hobi bermain game, ngoding, dan nonton anime. tiga hal yang mengasah imajinasi, logika, dan kreativitasnya.  
Dengan semangat untuk terus belajar dan berkembang, Ahmad selalu tertantang untuk mencoba hal-hal baru, mengeksplorasi ide-ide segar, dan menghadapi setiap tantangan dengan tekad yang kuat. Baginya, setiap pengalaman adalah peluang untuk tumbuh dan melangkah lebih dekat menuju cita-citanya.</p>
